...
const Search = ({ color = "black", height = 20, width = 20 }: IconProps) => (
...
const Calendar = ({ color = "gray", height = 20, width = 20 }: IconProps) => (
...
const Favorites = ({ color, height = 20, width = 20 }: IconProps) => (
  <Svg height={height} width={width} viewBox="0 0 384 512">
    <Path
      fill={color}
...
const Cloud = ({ color = "black", height = 20, width = 20 }: IconProps) => (
...
const Close = ({ color = "black", height = 20, width = 20 }: IconProps) => (
  <Svg height={height} width={width} viewBox="0 0 384 512">
    <Path
      fill={color}
...
const Icons = ({
  ...
  switch (name) {
    ...
    case "cloud":
      return <Cloud color={color} height={height} width={width} />;
    case "sunny":
      return <WeatherSunny color={color} height={height} width={width} />;
    case "cold":
      return <WeatherCold color={color} height={height} width={width} />;
    case "favorite":
      return <Favorites color={color} height={height} width={width} />;
    case "search":
